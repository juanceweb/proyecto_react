            ...
            <div className="row d-flex justify-content-center">
                <div className="col-3 card border border-dark border-3 bg-danger">
                    ...
                    <div className="card-body">
                        ...
                        <FunctAddRest getCantidad={(c) => setCantidad(c)} valorInicial={0} stockIni={8} />
                        <a href="#" className="btn btn-secondary m-3 border-dark border-2"><NavLink to="/cart">AGREGAR AL CARRITO</NavLink></a>
                    </div>
                </div>
                <div className="col-3 card border border-dark border-3 bg-danger">
